...
Seller.hasMany(Message, { foreignKey: 'sellerId', as: 'messages' });
Message.belongsTo(Seller, { foreignKey: 'sellerId', as: 'seller' });
Listing.hasMany(Message, { foreignKey: 'listingId', as: 'messages' });
...
module.exports = { sequelize, Seller, Listing, Message, RentalHistory, Deal, Product, User, Earning };