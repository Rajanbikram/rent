...
const seedProducts = [
  { name: "Modern 3-Seater Sofa", category: "furniture", image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=300&fit=crop", pricePerMonth: 2500, originalPrice: 3200, rating: 4.8, reviewCount: 124, location: "kathmandu", badge: "hotDeal", description: "Comfortable modern sofa with premium fabric upholstery. Perfect for living rooms.", stock: 10 },
  ...
  { name: "Samsung Refrigerator 250L", category: "appliances", image: "https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=400&h=300&fit=crop", pricePerMonth: 1500, originalPrice: 1800, rating: 4.7, reviewCount: 156, location: "kathmandu", badge: null, description: "Energy-efficient double door refrigerator with frost-free technology.", stock: 10 },
  { name: "Wooden Dining Table Set", category: "furniture", image: "https://images.unsplash.com/photo-1617806787461-102c1bfaaea1?w=400&h=300&fit=crop", pricePerMonth: 2200, originalPrice: 2800, rating: 4.5, reviewCount: 67, location: "pokhara", badge: "limitedTime", description: "6-seater dining table with matching chairs. Solid wood construction.", stock: 10 },
  { name: "LG Washing Machine 7kg", category: "appliances", image: "https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=400&h=300&fit=crop", pricePerMonth: 1200, originalPrice: 1500, rating: 4.4, reviewCount: 98, location: "kathmandu", badge: "hotDeal", description: "Front-load washing machine with multiple wash programs.", stock: 10 },
  { name: "Study Desk with Chair", category: "furniture", image: "https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=400&h=300&fit=crop", pricePerMonth: 900, originalPrice: 1100, rating: 4.9, reviewCount: 203, location: "kathmandu", badge: "studentOffer", description: "Ergonomic study desk with comfortable chair. Perfect for students.", stock: 10 },
  { name: "Split AC 1.5 Ton", category: "appliances", image: "https://images.unsplash.com/photo-1631545806609-12612c0a7b6a?w=400&h=300&fit=crop", pricePerMonth: 2000, originalPrice: 2500, rating: 4.3, reviewCount: 45, location: "pokhara", badge: null, description: "Energy-efficient split AC with fast cooling technology.", stock: 10 },
  { name: "Wardrobe 3-Door", category: "furniture", image: "https://images.unsplash.com/photo-1558997519-83ea9252edf8?w=400&h=300&fit=crop", pricePerMonth: 1600, originalPrice: 2000, rating: 4.6, reviewCount: 78, location: "kathmandu", badge: null, description: "Spacious 3-door wardrobe with mirror and multiple compartments.", stock: 10 }
];
...
async function seedRentalData() {
  try {
    ...
    // Delete old products to avoid duplicates
    await RentalProduct.destroy({ where: {} });
    await RentalReview.destroy({ where: {} });
    console.log('🗑️  Cleared old rental data');
